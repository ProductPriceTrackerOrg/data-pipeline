...
with DAG(
    ...
    start_task >> [
                    ...
                    scrape_cyberdeals_task
                                            ...
                                            ] >> categorize_task >> matching_task >> gnn_prediction_task >> price_forecasting_task >> anomaly_detection_task >> notification_service_task >> end_task
