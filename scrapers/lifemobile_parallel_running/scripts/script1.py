...
class LifeMobileSpider(scrapy.Spider):
    ...
    def parse_homepage(self, response):
        ...
        # Extract category URLs from navigation
...
if __name__ == "__main__":
    process = CrawlerProcess(
        settings={
            "FEED_FORMAT": "json",
            "FEED_URI": "lifemobile_products_script1.json",
            "LOG_LEVEL": "INFO",
    ...
    with open("script1.complete", "w") as f:
        f.write("DONE")
    logger.info("✅ Script 1 complete marker created")
