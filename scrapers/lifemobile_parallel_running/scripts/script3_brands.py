...
class LifeMobileSpider(scrapy.Spider):
    name = "lifemobile_script3"
    allowed_domains = ["lifemobile.lk"]
    start_urls = [
        "https://lifemobile.lk/product-category/apple/",
        "https://lifemobile.lk/product-category/samsung/",
        "https://lifemobile.lk/product-category/xiaomi/",
        "https://lifemobile.lk/product-category/huawei/",
    ]
    ...
    def parse_product(self, response):
        ...
        try:
            ...
            if self.products_collected % 10 == 0:
                ...
                logger.info(
                    f"Script3 Progress: {self.products_collected} products | {rate:.2f} products/sec | Errors: {self.error_count}"
                )
    ...
    def closed(self, reason):
        ...
        logger.info(
            f"Script3 finished scraping. Total products: {self.products_collected}"
        )
...
if __name__ == "__main__":
    process = CrawlerProcess(
        settings={
            "FEED_FORMAT": "json",
            "FEED_URI": "lifemobile_products_script3.json",
            "LOG_LEVEL": "INFO",
    ...
    with open("script3.complete", "w") as f:
        f.write("DONE")
    logger.info("✅ Script 3 complete marker created")
