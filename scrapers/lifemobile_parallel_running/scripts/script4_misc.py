...
class LifeMobileSpider(scrapy.Spider):
    name = "lifemobile_script4"
    allowed_domains = ["lifemobile.lk"]
    start_urls = [
        "https://lifemobile.lk/product-category/oppo/",
        "https://lifemobile.lk/product-category/vivo/",
        "https://lifemobile.lk/product-category/realme/",
        "https://lifemobile.lk/product-category/oneplus/",
        "https://lifemobile.lk/product-category/headphones/",
        "https://lifemobile.lk/product-category/power-banks/",
    ]
    ...
    def __init__(self):
        ...
        self.error_count = 0
        self.max_products = 10000  # Reduced for testing
    ...
    def parse_product(self, response):
        ...
        try:
            ...
            if self.products_collected % 10 == 0:
                ...
                logger.info(
                    f"Script4 Progress: {self.products_collected} products | {rate:.2f} products/sec | Errors: {self.error_count}"
                )
    ...
    def closed(self, reason):
        ...
        logger.info(
            f"Script4 finished scraping. Total products: {self.products_collected}"
        )
...
if __name__ == "__main__":
    process = CrawlerProcess(
        settings={
            "FEED_FORMAT": "json",
            "FEED_URI": "lifemobile_products_script4.json",
            "LOG_LEVEL": "INFO",
    ...
    with open("script4.complete", "w") as f:
        f.write("DONE")
    logger.info("✅ Script 4 complete marker created")
