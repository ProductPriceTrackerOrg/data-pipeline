...
# Create an initialization script for the credentials fix
# This script ensures GCP credentials are properly set up for BigQuery access
# It will be mounted into the Docker container and run during initialization

cat > init_gcp_creds.py << EOL
#!/usr/bin/env python3
import os
import json
import logging
...
chmod +x init_gcp_creds.py

echo "GCP credentials initialization script created successfully."
echo "Add this to your Docker container startup process."
